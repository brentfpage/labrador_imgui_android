...
void triggerUI::draw(inputsUI* inputs_ui)
{
    ...
    ImGui::BeginGroup();
        int free_space = ImGui::GetContentRegionAvail().x - ImGui::CalcTextSize("ChAChB").x - 2 * CHECKBOX_SIZE - 2 * style.ItemInnerSpacing.x - style.FramePadding.x * 2;
