Note: this readme and the .svg files in this directory are excluded from the assets that are included in the app.  This is done via the aaptOptions in /app/build.gradle.kts
...
load pulse.svg and svg(2)-converted.svg into https://icomoon.io/app/#/select to generate the font
